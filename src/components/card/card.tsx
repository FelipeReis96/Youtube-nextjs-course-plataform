    ...
    return (
        <Link href=''>
            <div className="flex flex-col p-2 ">
                <div className="sm:hover:bg-[var(--color-header)] p-2 rounded-lg">
                    <Image
                    src="https://i.ytimg.com/vi/WizgXUu8ZyI/hqdefault.jpg"
                    alt="Curso"
                    width={1000}
                    height={0}
                    draggable={false}
                    ...
                    <div className="bg-[var(--card-color)] rounded-lg p-4"> 
                        <h1 className="font-extrabold text-lg">Lorem Ipsum</h1>
